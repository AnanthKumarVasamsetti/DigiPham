        ...
        >
            <Paper elevation={1} sx={{ height: 600, width: 1000, }}>
                <Box
                    ...
                    src={require("../public/kitchen.png")}
                />
            </Paper>
            <Paper elevation={0} sx={{ height: 600, width: 1000, backgroundColor: '#232323', zIndex: 1}}>
                ...
                <Typography variant="h6" sx={{ marginTop: -50, marginLeft: 50, color: '#FFFFFF', fontSize: 100, fontFamily: 'serif' }}>
                    Kitchen
                </Typography>
                <Typography variant="subtitle1" sx={{ marginTop: 0, marginLeft: 50, color: '#FFFFFF', fontFamily: 'Helvetica'}}>
